...
<head>
    ...
    <style>
        :root {
            ...
            --text-dark: #1a202c; --text-muted: #718096;
        }
        body {
        ...
        .auth-wrapper {
            display: flex; gap: 0; width: 100%; max-width: 860px;
        ...
        .feature-icon {
            width: 32px; height: 32px; background: rgba(46,196,182,0.2);
            border-radius: 8px; display: flex; align-items: center; justify-content: center;
            color: var(--accent); font-size: 1rem; flex-shrink: 0;
        }

        .auth-panel-right {
            background: white; padding: 2.5rem; flex: 1;
        }
        ...
        .logo-icon {
            ...
            font-weight: 800; font-family: 'Sora', sans-serif; font-size: 0.9rem;
        }
        .logo-text {
        ...
        .form-control {
            ...
            padding: 0.65rem 1rem; font-family: 'DM Sans', sans-serif;
            transition: border-color 0.2s, box-shadow 0.2s;
        }
        .form-control:focus {
            border-color: var(--accent); box-shadow: 0 0 0 3px rgba(46,196,182,0.15); outline: none;
        }
        .btn-login {
            background: var(--primary); color: white; border: none;
            border-radius: 10px; padding: 0.75rem; font-family: 'Sora', sans-serif;
        ...
        @media (max-width: 640px) {
            ...
            .auth-panel-left { width: 100%; padding: 2rem; }
        }
    </style>
</head>
<body>
...
<div class="auth-wrapper">
    ...
    <div class="auth-panel-left">
        ...
        <div class="feature-item">
            ...
            Real micro-internship postings
        </div>
        <div class="feature-item">
            <div class="feature-icon"><i class="bi bi-trophy-fill"></i></div>
            Gamified Trust Points system
        </div>
        <div class="feature-item">
    ...
    <div class="auth-panel-right">
        ...
        <div class="demo-box">
            <strong>Demo Admin:</strong> admin@skillbridge.edu / password
        </div>
        ...
        <p class="text-center mt-4 mb-0" style="font-size: 0.9rem; color: var(--text-muted);">
            New to SkillBridge?
            <a href="register.php" style="color: var(--accent); font-weight: 600; text-decoration: none;">Create an Account</a>
        </p>
    </div>
</div>
