...
<head>
    ...
    <style>
           ...
           SKILLBRIDGE GLOBAL THEME
           Color Palette:
             --primary    #1d3557  (Deep Navy — authority, trust)
             --accent     #2ec4b6  (Teal — growth, opportunity)
             --highlight  #f4a261  (Amber — energy, action)
             --light-bg   #f0f4f8  (Off-white — clean background)
        ================================================================ */
        :root {
            --primary:    #1d3557;
            --accent:     #2ec4b6;
        ...
        .auth-card {
            ...
            border-radius: 20px;
            box-shadow: 0 20px 60px rgba(29, 53, 87, 0.12);
            padding: 2.5rem;
            width: 100%;
            max-width: 480px;
        }
